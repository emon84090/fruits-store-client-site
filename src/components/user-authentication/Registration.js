                        ...
                        <div className="login animate__animated animate__fadeInLeft">
                            <div className="login-content max-w-md mx-auto rounded-md flex items-center h-full justify-center flex-col  bg-white px-2 md:px-10">
                                ...
                                <form className='w-full px-2 mt-10'>
                                    ...
                                    <div className="input-field mb-3">
                                        <input placeholder='Confirm Password' className='p-4 w-full h-11 outline-none rounded-sm placeholder:text-sm bg-slate-300 bg-opacity-30 font-semibold text-gray-600' type="password" name="" required />
                                    </div>


                                    <div className="input-field">

                                        <button type='submit' className='disabled:bg-opacity-75 disabled:cursor-not-allowed cursor-pointer w-full h-11 outline-none rounded-sm placeholder:text-sm bg-yellow-500   text-white'>Sign Up</button>
                                    </div>
