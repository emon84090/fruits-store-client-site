        ...
        <>
            ...
            <section className="bg-white py-20 lg:py-[120px] overflow-hidden relative z-10">
                <div className="container mx-auto">
                    <span className="block  text-center text-2xl mb-14 font-bold">
                        Contact Us
                    </span>
                    <div className="flex flex-wrap lg:justify-between -mx-4">
                        <div data-aos="fade-right" className="w-full lg:w-1/2 xl:w-6/12 px-4">
                  ...
                  "
                     ...
                     "
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color">Fruitstore@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
