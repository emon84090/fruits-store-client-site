        ...
        <>
            ...
            <section class="bg-white py-20 lg:py-[120px] overflow-hidden relative z-10">
                <div class="container mx-auto">
                    <span class="block  text-center text-2xl mb-14 font-bold">
                        Contact Us
                    </span>
                    <div class="flex flex-wrap lg:justify-between -mx-4">
                        <div data-aos="fade-right" class="w-full lg:w-1/2 xl:w-6/12 px-4">
                  ...
                  "
                     ...
                     "
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="text-base text-body-color">Fruitstore@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
